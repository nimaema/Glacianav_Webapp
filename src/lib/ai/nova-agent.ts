      ...
      blocks: {
        ...
        items: {
          ...
          properties: {
            ...
            submitLabel: p("string", 'Optional concise submit label for a multiple-choice block.'),
